...
**draw cell-to-cell graph if you have low-dimensional coordinates such as UMAP1 and UMAP2**
...
**About 2 mins** please set @mycores >= 1 and @permutation_times >= 1,000 in the real setting
```{r, message = TRUE, warning = FALSE, cache = TRUE}
